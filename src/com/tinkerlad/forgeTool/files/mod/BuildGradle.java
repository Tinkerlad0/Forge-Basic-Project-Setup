...
public class BuildGradle {
	...
	private static final String buildGradle =
			"buildscript {" + System.lineSeparator() +
					...
					"}" + System.lineSeparator() +
					"" + System.lineSeparator() +
					"ext.configFile = file \"build.properties\"" + System.lineSeparator() +
					"" + System.lineSeparator() +
					"configFile.withReader {" + System.lineSeparator() +
					"    def prop = new Properties()" + System.lineSeparator() +
					"    prop.load(it)" + System.lineSeparator() +
					"    project.ext.config = new ConfigSlurper().parse prop" + System.lineSeparator() +
					"}" + System.lineSeparator() +
					"" + System.lineSeparator() +
					"apply plugin: 'forge'" + System.lineSeparator() +
					"" + System.lineSeparator() +
					"version = config.mod_version" + System.lineSeparator() +
					...
					"    version = config.forge_version" + System.lineSeparator() +
					...
					"    def releaseDir = new File('build/release/' + config.mod_version)" + System.lineSeparator() +
